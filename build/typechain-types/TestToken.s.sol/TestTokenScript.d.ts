...
export interface TestTokenScriptInterface extends utils.Interface {
    functions: {
...
export interface TestTokenScript extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestTokenScriptInterface;
