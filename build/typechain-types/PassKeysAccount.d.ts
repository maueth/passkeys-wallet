...
export interface PassKeysAccountInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addDeposit" | "addPassKey" | "entryPoint" | "execute" | "executeBatch" | "getAuthorisedKeys" | "getDeposit" | "initialize(string,uint256,uint256)" | "initialize(address)" | "nonce" | "owner" | "proxiableUUID" | "removePassKey" | "upgradeTo" | "upgradeToAndCall" | "validateUserOp" | "withdrawDepositTo"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "initialize(string,uint256,uint256)", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>
    ]): string;
...
export interface PassKeysAccount extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: PassKeysAccountInterface;
    ...
    functions: {
        ...
        getAuthorisedKeys(overrides?: CallOverrides): Promise<[
            PassKeyIdStructOutput[]
        ] & {
            knownKeys: PassKeyIdStructOutput[];
        }>;
        getDeposit(overrides?: CallOverrides): Promise<[BigNumber]>;
        "initialize(string,uint256,uint256)"(_keyId: PromiseOrValue<string>, _pubKeyX: PromiseOrValue<BigNumberish>, _pubKeyY: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getAuthorisedKeys(overrides?: CallOverrides): Promise<PassKeyIdStructOutput[]>;
        getDeposit(overrides?: CallOverrides): Promise<BigNumber>;
        "initialize(string,uint256,uint256)"(_keyId: PromiseOrValue<string>, _pubKeyX: PromiseOrValue<BigNumberish>, _pubKeyY: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
