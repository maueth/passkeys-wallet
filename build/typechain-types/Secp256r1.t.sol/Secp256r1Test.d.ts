...
export interface Secp256r1TestInterface extends utils.Interface {
    functions: {
        ...
        "testCheckSigWithPrecompute()": FunctionFragment;
        "testCheckSignature()": FunctionFragment;
        "testSingleSignatureVerify()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "IS_TEST" | "excludeArtifacts" | "excludeContracts" | "excludeSenders" | "failed" | "setUp" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetSelectors" | "targetSenders" | "testCheckSigWithPrecompute" | "testCheckSignature" | "testSingleSignatureVerify"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "testCheckSigWithPrecompute", values?: undefined): string;
    encodeFunctionData(functionFragment: "testCheckSignature", values?: undefined): string;
    encodeFunctionData(functionFragment: "testSingleSignatureVerify", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "testCheckSigWithPrecompute", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testCheckSignature", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testSingleSignatureVerify", data: BytesLike): Result;
    events: {
...
export interface Secp256r1Test extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: Secp256r1TestInterface;
    ...
    functions: {
        ...
        testCheckSigWithPrecompute(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testCheckSignature(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        testSingleSignatureVerify(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    IS_TEST(overrides?: CallOverrides): Promise<boolean>;
    ...
    callStatic: {
        ...
        targetSelectors(overrides?: CallOverrides): Promise<StdInvariant.FuzzSelectorStructOutput[]>;
        targetSenders(overrides?: CallOverrides): Promise<string[]>;
        testCheckSigWithPrecompute(overrides?: CallOverrides): Promise<void>;
        testCheckSignature(overrides?: CallOverrides): Promise<void>;
        testSingleSignatureVerify(overrides?: CallOverrides): Promise<void>;
    };
    filters: {
