...
export interface ExternalUpgradeScriptInterface extends utils.Interface {
    functions: {
...
export interface ExternalUpgradeScript extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ExternalUpgradeScriptInterface;
